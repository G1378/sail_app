      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-sm font-semibold text-gray-900">
            Sign-ups <span className="text-gray-400 font-normal">({signups.length})</span>
          </h2>
              ...
              <div key={signup.id} className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm">
                ...
                {(signup.boats || signup.focus_goal) && (
                  <div className="mt-3 pt-3 border-t border-gray-50 flex flex-wrap gap-3 text-xs text-gray-500">
                    {signup.boats && (
                      <span>
                        Preferred boat: <span className="font-medium text-gray-700">{signup.boats.name} ({signup.boats.type})</span>
                      </span>
                    )}
                    {signup.focus_goal && (
                      <span>
                        Focus: <span className="font-medium text-gray-700">{signup.focus_goal}</span>
                      </span>
                    )}
                  </div>
                )}
